...
OpCodeInfo OpCodes[256] =
{
	...
	// 0xC0 - 0xCF
	OpCodeInfo(0xC0, OpCode::RET, 1, 8, OperandType::None, OperandType::None, 20),
	OpCodeInfo(0xC1, OpCode::POP, 1, 12, OperandType::RegisterBC),
	OpCodeInfo(0xC2, OpCode::JP,  3, 12, OperandType::AddressUINT16, OperandType::None, 16),
	OpCodeInfo(0xC3, OpCode::JP,  3, 4, OperandType::AddressUINT16),
	OpCodeInfo(0xC4, OpCode::CALL,3, 12, OperandType::AddressUINT16, OperandType::None, 24),
	...
	OpCodeInfo(0xC8, OpCode::RET, 1, 8, OperandType::None, OperandType::None, 20),
	OpCodeInfo(0xC9, OpCode::RET, 1, 16),
	OpCodeInfo(0xCA, OpCode::JP,  3, 12, OperandType::AddressUINT16, OperandType::None, 16),
	OpCodeInfo(0xCB, OpCode::PREFIX, 1, 4),
	OpCodeInfo(0xCC, OpCode::CALL,3, 12, OperandType::AddressUINT16, OperandType::None, 24),
	...
	// 0xD0 - 0xDF
	OpCodeInfo(0xD0, OpCode::RET, 1, 8, OperandType::None, OperandType::None, 20),
	OpCodeInfo(0xD1, OpCode::POP, 1, 12),
	OpCodeInfo(0xD2, OpCode::JP,  3, 12, OperandType::AddressUINT16, OperandType::None, 16),
	OpCodeInfo(0xD3, OpCode::XXX, 1, 4),
	OpCodeInfo(0xD4, OpCode::CALL,2, 12, OperandType::AddressUINT16, OperandType::None, 24),
	...
	OpCodeInfo(0xD8, OpCode::RET, 1, 8, OperandType::None, OperandType::None, 20),
	OpCodeInfo(0xD9, OpCode::RETI,1, 16),
	OpCodeInfo(0xDA, OpCode::JP,  3, 12, OperandType::AddressUINT16, OperandType::None, 16),
	OpCodeInfo(0xDB, OpCode::XXX, 1, 4),
	OpCodeInfo(0xDC, OpCode::CALL,3, 12, OperandType::AddressUINT16, OperandType::None, 24),
	...
	OpCodeInfo(0xE9, OpCode::JP,  1, 4, OperandType::RegisterHLIndirect),
