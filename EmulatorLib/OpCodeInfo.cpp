...
OpCodeInfo OpCodeInfo::OpCodes[256] =
{
	...
	OpCodeInfo(0x18, OpCode::JR,  2, 12, OperandType::None, OperandType::DataUINT8),
	...
	// 0x20 - 0x2F
	OpCodeInfo(0x20, OpCode::JR,  2, 8, OperandType::FlagNotZero, OperandType::DataUINT8, 12),
	...
	OpCodeInfo(0x26, OpCode::LD,  2, 8, OperandType::RegisterH, OperandType::DataUINT8),
	OpCodeInfo(0x27, OpCode::DAA, 1, 4),
	OpCodeInfo(0x28, OpCode::JR,  2, 8, OperandType::FlagZero, OperandType::DataUINT8, 12),
	...
	// 0x30 - 0x3F
	OpCodeInfo(0x30, OpCode::JR,  2, 8, OperandType::FlagNotCarry, OperandType::DataUINT8, 12),
	...
	OpCodeInfo(0x38, OpCode::JR,  2, 8, OperandType::FlagCarry, OperandType::DataUINT8, 12),
	...
	// 0x90 - 0x9F
	OpCodeInfo(0x90, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterB),
	OpCodeInfo(0x91, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterC),
	OpCodeInfo(0x92, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterD),
	OpCodeInfo(0x93, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterE),
	OpCodeInfo(0x94, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterH),
	OpCodeInfo(0x95, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterL),
	OpCodeInfo(0x96, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::RegisterHLIndirect),
	OpCodeInfo(0x97, OpCode::SUB, 1, 4, OperandType::Acculumator, OperandType::Acculumator),
	...
	// 0xA0 - 0xAF
	OpCodeInfo(0xA0, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterB),
	OpCodeInfo(0xA1, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterC),
	OpCodeInfo(0xA2, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterD),
	OpCodeInfo(0xA3, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterE),
	OpCodeInfo(0xA4, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterH),
	OpCodeInfo(0xA5, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterL),
	OpCodeInfo(0xA6, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::RegisterHLIndirect),
	OpCodeInfo(0xA7, OpCode::AND, 1, 4, OperandType::Acculumator, OperandType::Acculumator),
	OpCodeInfo(0xA8, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterB),
	OpCodeInfo(0xA9, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterC),
	OpCodeInfo(0xAA, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterD),
	OpCodeInfo(0xAB, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterE),
	OpCodeInfo(0xAC, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterH),
	OpCodeInfo(0xAD, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterL),
	OpCodeInfo(0xAE, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::RegisterHLIndirect),
	OpCodeInfo(0xAF, OpCode::XOR, 1, 4, OperandType::Acculumator, OperandType::Acculumator),

	// 0xB0 - 0xBF
	OpCodeInfo(0xB0, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterB),
	OpCodeInfo(0xB1, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterC),
	OpCodeInfo(0xB2, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterD),
	OpCodeInfo(0xB3, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterE),
	OpCodeInfo(0xB4, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterH),
	OpCodeInfo(0xB5, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterL),
	OpCodeInfo(0xB6, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::RegisterHLIndirect),
	OpCodeInfo(0xB7, OpCode::OR, 1, 4, OperandType::Acculumator, OperandType::Acculumator),
	OpCodeInfo(0xB8, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterB),
	OpCodeInfo(0xB9, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterC),
	OpCodeInfo(0xBA, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterD),
	OpCodeInfo(0xBB, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterE),
	OpCodeInfo(0xBC, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterH),
	OpCodeInfo(0xBD, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterL),
	OpCodeInfo(0xBE, OpCode::CP, 1, 4, OperandType::Acculumator, OperandType::RegisterHLIndirect),
	...
	OpCodeInfo(0xC4, OpCode::CALL,3, 12, OperandType::FlagNotZero, OperandType::DataUINT16, 24),
	...
	OpCodeInfo(0xCC, OpCode::CALL,3, 12, OperandType::FlagZero, OperandType::DataUINT16, 24),
	OpCodeInfo(0xCD, OpCode::CALL,3, 24, OperandType::None, OperandType::DataUINT16),
	...
	OpCodeInfo(0xD4, OpCode::CALL,2, 12, OperandType::FlagNotCarry, OperandType::DataUINT16, 24),
	...
	OpCodeInfo(0xDC, OpCode::CALL,3, 12, OperandType::FlagCarry, OperandType::DataUINT16, 24),
	...
	OpCodeInfo(0xE2, OpCode::LD,  1, 4, OperandType::RegisterCIndirect, OperandType::Acculumator),
	...
	OpCodeInfo(0xE8, OpCode::ADD, 2, 16, OperandType::Stackpointer, OperandType::DataUINT8),
	...
	OpCodeInfo(0xF2, OpCode::LD,  1, 2, OperandType::Acculumator, OperandType::RegisterCIndirect),
	...
	OpCodeInfo(0xF8, OpCode::LD,  2, 12, OperandType::RegisterHL, OperandType::DataUINT8),
